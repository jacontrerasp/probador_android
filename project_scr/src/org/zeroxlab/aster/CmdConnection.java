...
class CmdConnection implements Runnable, ItemListener {
    ...
    public void run() {
        ...
        AsterMainPanel.message("Conectando con el dispotivo, recuerda activar el modo debbug en tu equipo...");
        MonkeyDeviceWrapper monkeyDevice = mCmdManager.connect();
        AsterMainPanel.message("Conectado");
        ...
        while (mKeepWalking) {
            ...
            try {
                ...
                String msg = "La actualizacion del hijo grafico esta interrumpido";
    ...
    private void updateScreen() {
        if (mDrawer == null) {
            System.out.println("No hay drawer para actualizar pantalla");
            return;
        }
